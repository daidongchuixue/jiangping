...
\subsection{定积分的定义}
	\centerline{$\left[a,b\right]\mbox{有限区间，},f(x)\mbox{在}\left[a,b\right]\mbox{上有界}$}
	\begin{figure}[htp]
		\begin{tikzpicture}[xscale=1.7,yscale=1.3,above left]
		...
		\end{tikzpicture}
		\begin{tikzpicture}[above right]
			\node at(0,3){$\begin{cases}
